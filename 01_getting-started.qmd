...
-   How to create, edit, and render Quarto documents to create rich documents that can embed computer code to dynamically render content.
-   How to install and load packages in R, and how they can make working with R much easier.
-   How file systems work and some best practices for working on projects.
